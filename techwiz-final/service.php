...
<body>
    ...
    <section>
        ...
        foreach ($result as $results){
            ?>
           <a href="?id=<?php echo $results['c_id']?>" <button type="submit" class="btn  m-3" id="btn"><?php echo $results['category_name'] ?></button></a>
            <?php
            }
            ?>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8">
                    <h4 class="start-0 mt-5" id="coming">GET IN TOUCH</h4>
                </div>
